    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asi', models.ForeignKey(to='laeutusteapp.Asi')),
                ('kes', models.ForeignKey(default=b'', to='laeutusteapp.Kes')),
                ('ruum', models.ForeignKey(to='laeutusteapp.Kohad')),
            ],
        ),
        migrations.CreateModel(
            name='Liik',
        ...
        migrations.AddField(
            model_name='asi',
            name='liik',
            field=models.ForeignKey(to='laeutusteapp.Liik'),
        ),
    ]
